def journalist(journalists)
    puts "Combien y a-t-il de journalistes dans ce array ?"
    puts "Il y a #{journalists.length} arrays"
end
  
def handle_1(journalists)
    counter = 0
    ...
    puts "Il y en a #{counter}"
end

def handle_2(journalists)
    counter = 0
      journalists.each do |email|
...
def underscore(journalists)
    puts "Combien y a-t-il de underscore  dans tous les pseudos confondus ?"
    counter = 0
    ...
    puts "Il y a au total, #{counter} underscore."
end
...
def perform
    ...
    handle_1(journalists)
    handle_2(journalists)
    begin_maj(journalists)
    have_maj(journalists)
